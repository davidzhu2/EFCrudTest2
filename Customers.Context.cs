...
namespace EFCrudTest2
{
    ...
    public partial class CalMaster : DbContext
    {
        public CalMaster()
            : base("name=CalMaster")
        {
        ...
        public DbSet<CALHistory> CALHistories { get; set; }
        public DbSet<CALPlant1> CALPlant1 { get; set; }
        public DbSet<CALPlant2> CALPlant2 { get; set; }
        public DbSet<CALUpateInfo> CALUpateInfoes { get; set; }
        public DbSet<CrimpersCAL> CrimpersCALs { get; set; }
        public DbSet<Plant1Track> Plant1Track { get; set; }
        ...
        public virtual ObjectResult<GetCalMonthDueReport_Result> GetCalMonthDueReport(string location_ID)
        {
            var location_IDParameter = location_ID != null ?
                new ObjectParameter("Location_ID", location_ID) :
                new ObjectParameter("Location_ID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCalMonthDueReport_Result>("GetCalMonthDueReport", location_IDParameter);
        }
    
        public virtual ObjectResult<GetCalMonthDueReport_Summary_Result> GetCalMonthDueReport_Summary(string location_ID)
        {
            var location_IDParameter = location_ID != null ?
                new ObjectParameter("Location_ID", location_ID) :
                new ObjectParameter("Location_ID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCalMonthDueReport_Summary_Result>("GetCalMonthDueReport_Summary", location_IDParameter);
        }
    
        public virtual ObjectResult<GetCalMonthDueReport_Summary_NextMonth_Result> GetCalMonthDueReport_Summary_NextMonth(string location_ID)
        {
            var location_IDParameter = location_ID != null ?
                new ObjectParameter("Location_ID", location_ID) :
                new ObjectParameter("Location_ID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCalMonthDueReport_Summary_NextMonth_Result>("GetCalMonthDueReport_Summary_NextMonth", location_IDParameter);
        }
    
        public virtual ObjectResult<GetCalOverDueReport_Result> GetCalOverDueReport(string location_ID)
        {
            var location_IDParameter = location_ID != null ?
                new ObjectParameter("Location_ID", location_ID) :
                new ObjectParameter("Location_ID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCalOverDueReport_Result>("GetCalOverDueReport", location_IDParameter);
        }
    
        public virtual ObjectResult<GetCalOverDueReport_Summary_Result> GetCalOverDueReport_Summary(string location_ID)
        {
            var location_IDParameter = location_ID != null ?
                new ObjectParameter("Location_ID", location_ID) :
                new ObjectParameter("Location_ID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCalOverDueReport_Summary_Result>("GetCalOverDueReport_Summary", location_IDParameter);
        }
    
        public virtual int InsertCALPlant1TestEquipment(string e_ID, string description, string manufacturer, string model_Name, string serial_Number, string due_Date, string rO, string owner_Name, string notes, string location)
        {
            ...
            var due_DateParameter = due_Date != null ?
                new ObjectParameter("Due_Date", due_Date) :
                new ObjectParameter("Due_Date", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertCALPlant1TestEquipment", e_IDParameter, descriptionParameter, manufacturerParameter, model_NameParameter, serial_NumberParameter, due_DateParameter, rOParameter, owner_NameParameter, notesParameter, locationParameter);
        }
    
        public virtual int InsertCALPlant2TestEquipment(string e_ID, string description, string manufacturer, string model_Name, string serial_Number, string due_Date, string rO, string owner_Name, string notes, string location)
        {
            var e_IDParameter = e_ID != null ?
                new ObjectParameter("E_ID", e_ID) :
                new ObjectParameter("E_ID", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertCALPlant2TestEquipment", e_IDParameter, descriptionParameter, manufacturerParameter, model_NameParameter, serial_NumberParameter, due_DateParameter, rOParameter, owner_NameParameter, notesParameter, locationParameter);
        }
    
        public virtual int InsertCrimpersCALTestEquipment(string e_ID, string description, string manufacturer, string model_Name, string serial_Number, string due_Date, string rO, string owner_Name, string notes, string location)
        {
            var e_IDParameter = e_ID != null ?
                new ObjectParameter("E_ID", e_ID) :
                new ObjectParameter("E_ID", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertCrimpersCALTestEquipment", e_IDParameter, descriptionParameter, manufacturerParameter, model_NameParameter, serial_NumberParameter, due_DateParameter, rOParameter, owner_NameParameter, notesParameter, locationParameter);
        }
    
        public virtual int InsertPlant1TrackTestEquipment(string e_ID, string description, string manufacturer, string model_Name, string serial_Number, string due_Date, string rO, string owner_Name, string notes, string location)
        {
            var e_IDParameter = e_ID != null ?
                new ObjectParameter("E_ID", e_ID) :
                new ObjectParameter("E_ID", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertPlant1TrackTestEquipment", e_IDParameter, descriptionParameter, manufacturerParameter, model_NameParameter, serial_NumberParameter, due_DateParameter, rOParameter, owner_NameParameter, notesParameter, locationParameter);
        }
    
        public virtual int InsertTempDataToCALUpateInfo()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertTempDataToCALUpateInfo");
        }
    
        public virtual int InsertTempDataToCALUpateInfo2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertTempDataToCALUpateInfo2");
        }
        ...
        public virtual int UpdateCALCrimpersTestEquipment(Nullable<int> iD, string description, string manufacturer, string model_Name, string serial_Number, string calibrated, string due_Date, string rO, string sENT_OUT, string found, string remarks, string cal_Location, string user_Name, string owner_Name, string cal_BACK_Date, Nullable<bool> active, string notes, string location, Nullable<bool> discarded, Nullable<bool> notInUse, string updatedBy, Nullable<System.DateTime> updatedDate)
        {
            ...
            var calibratedParameter = calibrated != null ?
                new ObjectParameter("Calibrated", calibrated) :
                new ObjectParameter("Calibrated", typeof(string));
            ...
            var sENT_OUTParameter = sENT_OUT != null ?
                new ObjectParameter("SENT_OUT", sENT_OUT) :
                new ObjectParameter("SENT_OUT", typeof(string));
    
            var foundParameter = found != null ?
                new ObjectParameter("Found", found) :
                new ObjectParameter("Found", typeof(string));
    
            var remarksParameter = remarks != null ?
                new ObjectParameter("Remarks", remarks) :
                new ObjectParameter("Remarks", typeof(string));
    
            var cal_LocationParameter = cal_Location != null ?
                new ObjectParameter("Cal_Location", cal_Location) :
                new ObjectParameter("Cal_Location", typeof(string));
            ...
            var cal_BACK_DateParameter = cal_BACK_Date != null ?
                new ObjectParameter("Cal_BACK_Date", cal_BACK_Date) :
                new ObjectParameter("Cal_BACK_Date", typeof(string));
            ...
            var discardedParameter = discarded.HasValue ?
                new ObjectParameter("Discarded", discarded) :
                new ObjectParameter("Discarded", typeof(bool));
    
            var notInUseParameter = notInUse.HasValue ?
                new ObjectParameter("NotInUse", notInUse) :
                new ObjectParameter("NotInUse", typeof(bool));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateCALCrimpersTestEquipment", iDParameter, descriptionParameter, manufacturerParameter, model_NameParameter, serial_NumberParameter, calibratedParameter, due_DateParameter, rOParameter, sENT_OUTParameter, foundParameter, remarksParameter, cal_LocationParameter, user_NameParameter, owner_NameParameter, cal_BACK_DateParameter, activeParameter, notesParameter, locationParameter, discardedParameter, notInUseParameter, updatedByParameter, updatedDateParameter);
        }
    
        public virtual int UpdateCALPlant1TestEquipment(Nullable<int> iD, string e_ID, string description, string manufacturer, string model_Name, string serial_Number, string calibrated, string due_Date, string rO, string sENT_OUT, string found, string remarks, string cal_Location, string user_Name, string owner_Name, string cal_BACK_Date, Nullable<bool> active, string notes, string imageFileName, string location, Nullable<bool> discarded, Nullable<bool> notInUse, string fileName1, string updatedBy, Nullable<System.DateTime> updatedDate)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            var fileName1Parameter = fileName1 != null ?
                new ObjectParameter("FileName1", fileName1) :
                new ObjectParameter("FileName1", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateCALPlant1TestEquipment", iDParameter, e_IDParameter, descriptionParameter, manufacturerParameter, model_NameParameter, serial_NumberParameter, calibratedParameter, due_DateParameter, rOParameter, sENT_OUTParameter, foundParameter, remarksParameter, cal_LocationParameter, user_NameParameter, owner_NameParameter, cal_BACK_DateParameter, activeParameter, notesParameter, imageFileNameParameter, locationParameter, discardedParameter, notInUseParameter, fileName1Parameter, updatedByParameter, updatedDateParameter);
        }
    
        public virtual int UpdateCALPlant2TestEquipment(Nullable<int> iD, string e_ID, string description, string manufacturer, string model_Name, string serial_Number, string calibrated, string due_Date, string rO, string sENT_OUT, string found, string remarks, string cal_Location, string user_Name, string owner_Name, string cal_BACK_Date, Nullable<bool> active, string notes, string imageFileName, string location, Nullable<bool> discarded, Nullable<bool> notInUse, string fileName1, string updatedBy, Nullable<System.DateTime> updatedDate)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateCALPlant2TestEquipment", iDParameter, e_IDParameter, descriptionParameter, manufacturerParameter, model_NameParameter, serial_NumberParameter, calibratedParameter, due_DateParameter, rOParameter, sENT_OUTParameter, foundParameter, remarksParameter, cal_LocationParameter, user_NameParameter, owner_NameParameter, cal_BACK_DateParameter, activeParameter, notesParameter, imageFileNameParameter, locationParameter, discardedParameter, notInUseParameter, fileName1Parameter, updatedByParameter, updatedDateParameter);
        }
    
        public virtual int UpdateTestEquipmentDueDateFromVendor()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateTestEquipmentDueDateFromVendor");
        }
    
        public virtual int UpdateTestEquipmentDueDateFromVendorCALPlant2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateTestEquipmentDueDateFromVendorCALPlant2");
        }
    
        public virtual int UpdateTestEquipmentDueDateFromVendorCrimpersCAL()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UpdateTestEquipmentDueDateFromVendorCrimpersCAL");
        }
    }
}
